/*global define*/
define(['Core/defined', 'Core/DeveloperError', 'Core/Cartesian2', 'Core/Cartesian3', 'Core/CornerType', 'Core/ComponentDatatype', 'Core/Ellipsoid', 'Core/EllipsoidTangentPlane', 'Core/Geometry', 'Core/IndexDatatype', 'Core/Math', 'Core/Matrix3', 'Core/PolylinePipeline', 'Core/PrimitiveType', 'Core/Quaternion', 'Core/defaultValue', 'Core/BoundingSphere', 'Core/GeometryAttribute', 'Core/GeometryAttributes', 'Core/VertexFormat'], function(
        defined,
        DeveloperError,
        Cartesian2,
        Cartesian3,
