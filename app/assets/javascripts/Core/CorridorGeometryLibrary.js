/*global define*/
define(['Core/defined', 'Core/Cartesian2', 'Core/Cartesian3', 'Core/CornerType', 'Core/EllipsoidTangentPlane', 'Core/PolylinePipeline', 'Core/Matrix3', 'Core/Quaternion', 'Core/Math'], function(
        defined,
        Cartesian2,
        Cartesian3,
        CornerType,
