/*global define*/
define(['Core/DeveloperError', 'Core/binarySearch', 'Core/defined', 'Core/defaultValue', 'Core/TimeConstants', 'Core/LeapSecond', 'Core/TimeStandard', 'Core/isLeapYear', 'ThirdParty/sprintf'], function(
        DeveloperError,
        binarySearch,
        defined,
        defaultValue,
