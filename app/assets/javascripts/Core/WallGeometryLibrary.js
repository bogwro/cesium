/*global define*/
define(['Core/defined', 'Core/Cartographic', 'Core/Cartesian3', 'Core/DeveloperError', 'Core/EllipsoidTangentPlane', 'Core/PolygonPipeline', 'Core/PolylinePipeline', 'Core/Math', 'Core/WindingOrder'], function(
        defined,
        Cartographic,
        Cartesian3,
        DeveloperError,
