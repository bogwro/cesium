/*global define*/
define(['Core/defaultValue', 'Core/defined', 'Core/Event', 'Core/Iso8601', 'Core/TimeInterval', 'Core/DeveloperError', 'DynamicScene/DynamicObject', 'DynamicScene/DynamicBillboard', 'DynamicScene/DynamicClock', 'DynamicScene/DynamicEllipse', 'DynamicScene/DynamicEllipsoid', 'DynamicScene/DynamicCone', 'DynamicScene/DynamicLabel', 'DynamicScene/DynamicPath', 'DynamicScene/DynamicPoint', 'DynamicScene/DynamicPolygon', 'DynamicScene/DynamicPolyline', 'DynamicScene/DynamicPyramid', 'DynamicScene/DynamicVector'], function(
        defaultValue,
        defined,
        Event,
        Iso8601,
