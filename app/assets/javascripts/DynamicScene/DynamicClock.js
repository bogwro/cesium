/*global define*/
define(['Core/Clock', 'Core/defaultValue', 'Core/defined', 'Core/defineProperties', 'Core/DeveloperError', 'Core/Event', 'DynamicScene/createDynamicPropertyDescriptor'], function(
        Clock,
        defaultValue,
        defined,
        defineProperties,
