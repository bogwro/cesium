/*global define*/
define(['Core/Cartesian3', 'Core/defaultValue', 'Core/defined', 'Core/defineProperties', 'Core/DeveloperError', 'Core/Ellipsoid', 'Core/Event', 'Core/Shapes', 'DynamicScene/createDynamicPropertyDescriptor'], function(
        Cartesian3,
        defaultValue,
        defined,
        defineProperties,
