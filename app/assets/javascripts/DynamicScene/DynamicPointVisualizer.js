/*global define*/
define(['Core/Color', 'Core/defaultValue', 'Core/defined', 'Core/destroyObject', 'Core/DeveloperError', 'Scene/BillboardCollection', 'Renderer/TextureAtlasBuilder'], function(
        Color,
        defaultValue,
        defined,
        destroyObject,
