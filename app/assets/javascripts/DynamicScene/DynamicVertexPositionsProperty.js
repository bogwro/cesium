/*global define*/
define(['Core/defined', 'Core/TimeInterval', 'Core/TimeIntervalCollection', 'Core/Cartesian3', 'Core/Cartographic', 'Core/Iso8601', 'Core/Ellipsoid', 'DynamicScene/ReferenceProperty'], function(
        defined,
        TimeInterval,
