/*global define*/
define(['Core/Color', 'Core/defaultValue', 'Core/defined', 'Core/DeveloperError', 'Core/BoundingRectangle', 'Core/RuntimeError', 'Core/WindingOrder', 'Renderer/CullFace', 'Renderer/DepthFunction', 'Renderer/BlendEquation', 'Renderer/BlendFunction', 'Renderer/StencilFunction', 'Renderer/StencilOperation'], function(
        Color,
        defaultValue,
        defined,
        DeveloperError,
