/*global define*/
define(['Core/defined', 'Core/defaultValue', 'Core/Color', 'Core/ComponentDatatype', 'Core/DeveloperError', 'Core/FeatureDetection', 'Core/Geometry', 'Core/GeometryAttribute', 'Core/GeometryPipeline', 'Core/Matrix4'], function(
        defined,
        defaultValue,
        Color,
        ComponentDatatype,
