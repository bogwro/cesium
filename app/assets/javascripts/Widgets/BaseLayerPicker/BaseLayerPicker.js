/*global define*/
define(['Core/defined', 'Core/defineProperties', 'Core/destroyObject', 'Core/DeveloperError', 'Widgets/getElement', 'Widgets/BaseLayerPicker/BaseLayerPickerViewModel', 'ThirdParty/knockout'], function(
        defined,
        defineProperties,
        destroyObject,
        DeveloperError,
