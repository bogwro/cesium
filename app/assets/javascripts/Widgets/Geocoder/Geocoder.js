/*global define*/
define(['Core/defined', 'Core/defineProperties', 'Core/destroyObject', 'Core/DeveloperError', 'Widgets/SvgPath/SvgPath', 'Widgets/getElement', 'Widgets/subscribeAndEvaluate', 'Widgets/Geocoder/GeocoderViewModel', 'ThirdParty/knockout'], function(
        defined,
        defineProperties,
        destroyObject,
        DeveloperError,
